...
namespace bitsquid_timpani
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            Directory.CreateDirectory(path + "\\bstim_extracted");
            ...
            while (num3 < fileCounts)
            {
                ...
                if (num5 == 1)
                {
                    ...
                    binaryReader.ReadInt32();
                    fileStream3 = new FileStream(path + "\\bstim_extracted\\" + outFileName[(int)(checked(num3))].ToString("X16") + ".wav", FileMode.Create);
                ...
                if (num5 == 22127)
                {
                    fileStream3 = new FileStream(path + "\\bstim_extracted\\" + outFileName[(int)(checked(num3))].ToString("X16") + ".ogg", FileMode.Create);
